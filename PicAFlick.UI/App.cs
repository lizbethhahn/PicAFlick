...
namespace PicAFlick.UI
{
    public class App
    {
        ...
        public App(ITmdbApiClient tmdbApiClient, UserContext context)
        {
            ...
            while (continueRunning)
            {
                ...
                switch (input)
                {
                    case "1":
                        ...
                        Console.Clear();
                        await MovieTitleSearchAsync();
                        break;
                    case "2":
                        // Call method to search for a TV show
                        await TvShowTitleSearchAsync();
                        break;
                    case "3":
        ...
        private async Task MovieTitleSearchAsync()
        {
